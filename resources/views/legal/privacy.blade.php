...
<div class="container">
    ...
    <p>When you register for an Account, we may ask for your contact information, including items such as your email address.</p>
    ...
    <ul>
        ...
        <li>Provide server owners with anonymous analytics based on their server including ip copies, votes and online players</li> 
    </ul>
    
    <h2>Log Files</h2>
    
    <p>{{config("app.name")}} follows a standard procedure of using log files. These files log visitors when they visit websites.
    ...
    <p>To track and analyse the usage of {{config("app.name")}} we use Google Analytics.</p>
    ...
    <p>If you make a request, we have one month to respond to you. If you would like to exercise any of these rights, please contact us at help@mcserver-list.net</p>
    ...
    <p>By continuing to use {{config("app.name")}} you agree to our privacy policy, you should also take a look at our <a href="{{route('legal.terms')}}">Terms and Conditions</a>.</p>
    <b><em>This policy was last reviewed on 6th April 2020 at 1:27pm</em></b>
</div>
@endsection